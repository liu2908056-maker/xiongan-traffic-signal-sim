# 雄安 20 路口交通信号协同管控仿真平台

> 基于 CityFlow 的雄安 20 路口交通信号协同管控仿真平台，集成 UGAT + FRAP 协同优化算法
> 源自挑战杯「揭榜挂帅」XH-202613 赛道 B「经典交通管控算法的场景适配与优化」

---

## 一、项目简介

本仓库基于 [CityFlow](https://github.com/cityflow-project/CityFlow) 交通仿真引擎，构建了面向雄安新区 20 路口场景的交通信号协同管控仿真平台，集成 UGAT（图注意力信号控制）+ FRAP（相位竞争学习）协同优化算法，提供 Docker 化部署方案与完整的可复现实验记录。
